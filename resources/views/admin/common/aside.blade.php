    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item <?php echo (Str::startsWith($route, 'dashboard')) ? "menu-item-here" : '' ?>"
                    aria-haspopup="true">
                ...
                <li class="menu-item <?php echo (Str::startsWith($route, 'permissions')) ? "menu-item-here" : '' ?>"
                    aria-haspopup="true">
                ...
                <li class="menu-item <?php echo (Str::startsWith($route, 'sites')) ? "menu-item-here" : '' ?>"
                    aria-haspopup="true">
                    <a href="{{route("sites.index")}}" class="menu-link">
                        ...
                        <span class="menu-text">@lang("Sites")</span>
                    </a>
                </li>

                <li class="menu-item <?php echo (Str::startsWith($route, 'roles')) ? "menu-item-here" : '' ?>"
                    aria-haspopup="true">
                ...
                <li class="menu-item <?php echo (Str::startsWith($route, 'users')) ? "menu-item-here" : '' ?>"
                    aria-haspopup="true">
