<div id="kt_header" class="header header-fixed">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="header-menu-wrapper header-menu-wrapper-left mt-5">
            <!--begin::Info-->
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@lang($header_title)</h5>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover py-4">
                        <!--begin::Item-->
                        <li class="navi-item">
                            <a href="{{route('langue',['locale' => 'en'])}}" class="navi-link">
                        ...
                        <!--begin::Item-->
                        <li class="navi-item">
                            <a href="{{route('langue', ['locale' => 'fr'])}}" class="navi-link">
													<span class="symbol symbol-20 mr-3">
