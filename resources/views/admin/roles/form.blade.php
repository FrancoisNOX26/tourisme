    ...
    <div class="form-group row">
        ...
        <div class="col-lg-9 col-xl-9">
            <div class="input-group input-group-solid input-group-lg">
                ...
                <input type="text" class="form-control form-control-solid form-control-lg @error('name') is-invalid @enderror" name="name" id="name" value="@if($route == 'roles.create'){{old('name')}}@else{{$role->name}}@endif"/>
            </div>
            @error('name')
