...
@section('title')
    {{ config('app.name') }} | @lang('Sites') | @lang('Create')
@endsection
                                    ...
                                    <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                        <div class="col-xl-12 col-xxl-10">
                                            ...
                                            <form class="form" id="create_form" method="POST"
                                                  action="{{ route('sites.store') }}" enctype="multipart/form-data">
                                                @csrf
...
@section('navigation')
    ...
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold my-1 mr-5"><a href="{{route('sites.index')}}">@lang('Site Management')</a></h5>
        <!--end::Page Title-->
        <!--begin::Breadcrumb-->
