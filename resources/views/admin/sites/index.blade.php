                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">@lang('Sites list')

                            </h3>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('sites.create') }}" class="btn btn-primary font-weight-bolder">
                                ...
                                @foreach ($items as $site)
                                    <tr data-entry-id="{{ $site->id }}">
                                        ...
                                        <td>
                                            ...
                                            <a href="#"
                                               onclick="event.preventDefault(); document.getElementById('delete-{{$site->id}}').submit()"
                                            ...
                                            <form id="delete-{{$site->id}}" method="POST" style="display: none"
